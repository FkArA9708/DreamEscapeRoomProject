...
include_once "dbcon.php";
 ...
 function crudMain(){
    ...
    <h1>Crud Vragen</h1>
    <nav>
		<a href='insert_crud.php'>Toevoegen nieuwe vraag</a>
    </nav><br>";
    echo $txt;
...
function printCrudTabel($result){
    ...
    foreach ($result as $row) {
        ...
        // Wijzig knopje
        $table .= "<td>
            <form method='post' action='update_crud.php?id=$row[id]' >       
                <button>Wzg</button>	 
            </form></td>";

        // Delete knopje
        $table .= "<td>
            <form method='post' action='delete_crud.php?id=$row[id]' >       
...
function insertRecord($post){
    ...
    // Maak een query 
    $sql = "
        INSERT INTO " . CRUD_TABLE . " (question, hint, answer, roomId)
        VALUES (:question, :hint, :answer, :roomId) 
    ";
